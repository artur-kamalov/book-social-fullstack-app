...
import com.artur.book.file.FileStorageService;
...
public class BookService {
  ...
  public PageResponse<BookResponse> findAllBooksByOwner(
    ...
    Page<Book> books = bookRepository.findAll(
      BookSpecification.withOwner(user.getId()),
      pageable
    );
  ...
  public Integer updateShareableStatus(
    Integer bookId,
    Authentication connectedUser
  ) {
  ...
  public Integer updateArchivedStatus(
    Integer bookId,
    Authentication connectedUser
  ) {
    Book book = bookRepository
  ...
  public Integer borrowBook(
    ...
    return transactionHistoryRepository
      .save(bookTransactionHistory)
      .getId();
  }

  public Integer returnBorrowedBook(
    Integer bookId,
    Authentication connectedUser
  ) {
    Book book = bookRepository
  ...
  public Integer approveReturnBorrowedBook(
    Integer bookId,
    Authentication connectedUser
  ) {
    Book book = bookRepository
    ...
    BookTransactionHistory bookTransactionHistory = transactionHistoryRepository
      ...
      .orElseThrow(() -> new OperationNotPermittedException("The book is not returned yet or you are not owner of this book"));
